...
* soc_init(n)     Initial state-of-charge of battery n
...
* temp_init(n)    Initial temperature of battery n
...
soc_capacity(n) Scaling factor for soc to convert k[M]Wh to percentages for battery n
;
