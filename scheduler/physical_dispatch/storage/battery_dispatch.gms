...
* $set market_uid TEST201801280005
* $set previous_uid TEST201801280000
* $set market_uid TSRTM201801280000
...
* Rescale soc to percentage (and rescale to kWh)
...
*dcmax_n             Maximum discharge power of battery n                                        /0/
*chmax_n             Maximum charge power of battery n                                           /0/
